...
<p>Spartin 基因的突變與遺傳性痙攣性截癱（SPG20）有關，這是一種神經退行性疾病。Troyer syndrome 是與 Spartin 基因相關的疾病，其特徵包括痙攣性截癱、說話困難、情緒不穩和短小身材，但通常壽命正常。更多相關的表型和疾病信息可以在 <a href="https://omim.org/entry/607111" target="_blank" rel="noopener">OMIM - SPG20</a> 上找到。</p>
 ...
 <div class="container">
    ...
    <div class="content">
        ...
        <h3>1. 區分兩個異構體的引子設計</h3>
        <p>這一組引子設計的目的是同時擴增兩個異構體，但產生不同大小的片段，來區分有無外顯子 14 的存在。</p>
        <table>
            <thead>
                <tr>
                    <th>引子類型</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td>外顯子 13 前端</td>
                    <td>外顯子 15 後端</td>
                    <td>此設計會擴增兩個異構體，ex14D-Ezh2 產生較短片段，ex14-Ezh2 產生較長片段。</td>
                </tr>
            </tbody>
        </table>

        <h3>2. 專一性擴增引子設計</h3>
        <p>這組引子將分別針對每個異構體，進行專一性擴增。</p>
        <table>
            <thead>
                <tr>
                    <th>異構體類型</th>
            ...
            <tbody>
                <tr>
                    <td>ex14-Ezh2 專一擴增</td>
                    <td>外顯子 13 前端</td>
                    <td>外顯子 14 後端</td>
                    <td>專門擴增包含外顯子 14 的異構體。</td>
                </tr>
                <tr>
                    <td>ex14D-Ezh2 專一擴增</td>
                    <td>外顯子 13 前端</td>
                    <td>外顯子 15 後端</td>
                    <td>專門擴增缺少外顯子 14 的異構體。</td>
                </tr>
            </tbody>
        </table>

        <h3>3. 總異構體擴增設計</h3>
        <p>為了擴增所有異構體而不包含外顯子 3、4、8 或 14 的片段，我們設計了一組引子，專門擴增共同包含的外顯子區域。</p>
        <table>
            <thead>
                <tr>
                    <th>引子類型</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td>外顯子 9 前端</td>
                    <td>外顯子 12 後端</td>
                    <td>擴增所有 Ezh2 異構體，但排除外顯子 3、4、8 和 14。</td>
                </tr>
            </tbody>
        </table>

        <p>
            這三組引子設計的目的是在不同情境下檢測 Ezh2 異構體，並區分是否包含外顯子 14，提供專一性擴增和總異構體的檢測方案。
        </p>
    </div>
</div>
<script>
